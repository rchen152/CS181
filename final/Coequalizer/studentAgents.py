...
num_states = 450
num_actions = 4
sa = open('Coequalizer/small_arr.p','r')
...
'''value_mat_file = open('Coequalizer/value_matrix.p','r')
...
class FisherAgent(CoequalizerAgent):
...
class CollectAgent(CoequalizerAgent):
    ...
    def chooseAction(self,observedState):
        ...
        if (observedState.getNumMovesLeft() == 1):
            sa_file = open("Coequalizer/small_arr.p","w")
